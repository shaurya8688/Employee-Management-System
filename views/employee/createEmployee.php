                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <input id="firstName" class="form-control col-md-7 col-xs-12" data-parsley-length="[6, 50]" data-parsley-required="true" name="firstName" placeholder="Jon" required="required" type="text">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="lastName" class="form-control col-md-7 col-xs-12" data-parsley-length="[6, 50]" data-parsley-required="true" name="lastName" placeholder="Doe" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="number" name="number" data-validate-minmax="0,100" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="item form-group">
